...
total_data = pd.read_csv\
    (f"/media/saad/943851B3385194D8/DataEng/Python/ideas/twitter-sentiment-analysis/dataset/train.csv", \
        encoding="ISO-8859-1")
with open('/media/saad/943851B3385194D8/DataEng/Python/ideas/twitter-sentiment-analysis/assets/contractions.json', 'r') as f:
...
plt.savefig('/media/saad/943851B3385194D8/DataEng/Python/ideas/twitter-sentiment-analysis/assets/positive_words.png')
plt.show()
...
plt.savefig('/media/saad/943851B3385194D8/DataEng/Python/ideas/twitter-sentiment-analysis/negetive_words.png')
plt.show()
...
plt.savefig("/media/saad/943851B3385194D8/DataEng/Python/ideas/twitter-sentiment-analysis/confusion_matrix.png")
plt.show()
...
plt.savefig("/media/saad/943851B3385194D8/DataEng/Python/ideas/twitter-sentiment-analysis/assets/ROC_curve.png")
plt.show()